...
##### txt_* functions #####
{
  ...
  # rm blank (or spaces only) lines in the text. usage:
  # ```
  # txt_rmblank PATH_TO_FILE
  # txt_rmblank <<< "line1"$'\n'$'\n'"line3"
  # ```
  txt_rmblank() {
    local txt="${1}"
